...
const benefits = [
  {
    icon: Banknote,
    title: 'Raus aus der Pauschalabschreibung',
    copy: 'Statt der pauschalen 2 % AfA ermitteln wir auf Basis des tatsächlichen Gebäudezustands, wie viel Sie wirklich abschreiben können.',
  },
  {
    icon: Landmark,
    title: 'Vom Finanzamt anerkannte Methodik',
    copy: 'Unsere Gutachten basieren auf dem BFH-Urteil vom 28.07.2021 und werden nach ImmoWertV erstellt.',
  },
];
  ...
  return (
    <section id="vorteile" className="section-shell pb-24 pt-16 md:pb-32 md:pt-20">
      ...
      >
        ...
        <h2 className="section-title mx-auto mb-5 max-w-5xl !text-[clamp(2.4rem,5vw,4.6rem)]">
          Mehr Abschreibung. Weniger Steuern.
        </h2>
        <p className="section-copy mx-auto max-w-3xl">
          Das Finanzamt rechnet pauschal – wir nicht. Wir ermitteln die tatsächliche Restnutzungsdauer Ihrer Immobilie und erhöhen damit Ihre jährliche Abschreibung gezielt.
        </p>
      </motion.div>
        ...
        {benefits.map((benefit, index) => (
          ...
          >
            <div className="flex items-start justify-between gap-5">
              ...
              <span className="rounded-full bg-[var(--color-accent-soft)] px-3 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-[var(--color-accent)]">
                RND
              </span>
            </div>

            <h3 className="mt-8 font-heading text-3xl font-semibold tracking-tight text-[var(--color-primary)] md:text-4xl">
              {benefit.title}
            </h3>
            ...
            <div className="mt-9 rounded-[1.4rem] border border-[var(--color-border)] bg-[var(--color-surface-strong)] p-5 shadow-sm">
              ...
              <div className="space-y-3">
                ...
                <div className="h-2.5 w-4/5 rounded-full bg-[var(--color-surface-muted)]" />
                <div className="h-2.5 w-3/5 rounded-full bg-[var(--color-accent)]/70" />
              </div>
            </div>
          </motion.article>
        ))}
