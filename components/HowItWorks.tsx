...
export default function HowItWorks() {
  ...
  return (
    <section id="ablauf" ref={containerRef} className="relative overflow-hidden border-t border-[var(--color-border)] bg-[var(--color-bg)] py-24 md:py-40">
      <motion.div
      ...
      <div
        className="absolute left-1/2 top-0 bottom-0 hidden w-px -translate-x-1/2 bg-[var(--color-border)] md:block"
        style={{
      ...
      <motion.div
        ...
        className="absolute left-1/2 top-0 bottom-0 hidden w-px origin-top -translate-x-1/2 bg-[var(--color-accent)] z-10 md:block"
      />
      ...
      <div className="section-shell relative z-10 flex flex-col gap-16 md:gap-28">
        {[
          ...
          },
          {
            ...
            copy: 'Laden Sie relevante Dokumente wie Grundbuchauszug oder Objektfotos bequem und vertraulich in unserem Portal hoch.',
            icon: FilePlus,
            align: 'left',
          },
          {
