  ...
  return (
    <section id="faq" className="relative z-10 mx-auto max-w-[1180px] scroll-mt-32 overflow-hidden px-4 py-20 sm:px-6 md:py-28">
      ...
      >
        ...
        <h2 className="font-heading text-4xl font-semibold leading-[1.02] tracking-[-0.055em] text-[var(--color-ink)] sm:text-5xl lg:text-6xl">
      ...
      <div className="rounded-[2rem] border border-[var(--color-border)] bg-[rgba(255,255,255,0.74)] p-3 shadow-[var(--shadow-lift)] backdrop-blur-2xl sm:p-4 md:rounded-[2.4rem] md:p-5">
        <div className="mb-3 flex items-center justify-center gap-3 px-2 py-2 text-sm font-bold uppercase tracking-[0.18em] text-[var(--color-text-muted)] sm:px-3">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <span className="min-w-0 flex-1 text-balance text-[1.05rem] font-semibold leading-6 tracking-[-0.02em] text-[var(--color-ink)] sm:text-xl sm:leading-7 lg:text-[1.28rem] lg:leading-8">
                      {faq.question}
                    </span>
