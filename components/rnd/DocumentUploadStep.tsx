  ...
  return (
    <div>
      <div className="mx-auto mb-8 max-w-3xl text-center">
        ...
        <p className="mt-4 text-base leading-7 text-[var(--color-text-muted)]">PDF-Unterlagen können Sie freiwillig jetzt ergänzen oder später nachreichen.</p>
      </div>
      <div className="mx-auto max-w-3xl">
        ...
        >
          ...
          <label className="rnd-secondary-btn mx-auto mt-5 w-fit cursor-pointer flex-col gap-1.5 px-6"><FileText size={18} className="mx-auto" /><span>Dateien auswählen</span><input type="file" accept="application/pdf,.pdf" multiple onChange={handleInput} className="sr-only" /></label>
        </div>
