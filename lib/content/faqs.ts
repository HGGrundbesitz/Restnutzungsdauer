export const FAQS = [
  ...
  },
  {
    ...
    answer: 'Nein. Das Gutachten bezieht sich auf die Restnutzungsdauer und die technische beziehungsweise bewertungsbezogene Herleitung. Steuerliche Entscheidungen und Einreichung sollten über Ihre Steuerberatung begleitet werden.',
  },
  {
    question: 'Wie wirkt sich eine höhere AfA auf meinen Cashflow aus?',
    answer: 'Eine kürzere begründbare Restnutzungsdauer kann die jährliche Abschreibung erhöhen. Der konkrete steuerliche Effekt hängt von Objekt, Kaufpreisaufteilung und Ihrer persönlichen Situation ab.',
  },
  {
...
export const INITIAL_VISIBLE_FAQ_COUNT = 5;
